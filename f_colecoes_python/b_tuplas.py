...
1 - As tuplas são representadas por paresenteses ()
...
tupla1 = tupla1 + tupla2  # Tuplas são imutávies, mas podemos sobrescrever seus valçores
print(tupla1)
...
# O acesso de elementos de uma tupla também é sxemelhante a de uma lista
...
nova = tupla  # Na tupla não temos o problema de ShallowCopy
