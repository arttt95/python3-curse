"""
Dicionários
OBS: Em algumas linguagens de programação, os dicionários Pyython são conhecidos
por mapas.
...
e não sera gerado o erro KeyError
...
OBS: O tipo None é sempre considerado False
...
# OBS 1: Aqui precisamos sempre informar a chave e caso não encontre o elemento,
...
# Desta forma,  facilmente adicionamos ou removemos produtos no carrinho e
# em cada produto podemos ter a certeza sobre cada informação.

# Limpar um dicionário (Zerar dados)
