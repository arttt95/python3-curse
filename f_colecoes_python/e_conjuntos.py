...
mas não nos importamos com a ordenação dele. Quando não precisamos nos preocupar
com chaves, valores e itens dupplicados.
...
# Importante lembrar que além de termos valores duplicados, não temos ordem
...
# Poedemos iterar em um set normalmente
...
# Imagine que fizemos um formulário de cadastro de visitantes em uma feira ou um museu
...
# OBS: Caso o valor não seja encontrado será gerado o error KeyError. Nenhum valor é retornado.
...
# {'Julia', 'Patricia', 'Ana', 'Fernando', 'Gustavo', 'Guilherme', 'Pedro', 'Marcos', 'Ellen'}
# unicos1 = estudantes_java.union(estudantes_python)
# {'Ellen', 'Patricia', 'Marcos', 'Fernando', 'Pedro', 'Guilherme', 'Ana', 'Julia', 'Gustavo'}
print(unicos1)
...
# Imagine que temos dois conjuntos: Um contendo estudantes do curso Python e
...
# * Se os valores forem interios ou reais (pontos flutuantes)
