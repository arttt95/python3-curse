...
Módulo Random -> Possui várias funções para geraão de números pseudo_aleatório.
...
# dentro do módulo ficarão disponíevis (Ficarão em Memória). Caso você saiba quais funções você precisa utilizar
# deste módulo, então esta não seria a forma ideal de utilização. Nós vveremos uma forma melhor na Forma 2.
...
for i in range(6):
    print(randint(1, 61), end=', ')  # Começa em 1 e vai até 60 gerando apenas números inteiros.

# choice() -> Mostra um valor pseudo-aleatório entre um iterável.
