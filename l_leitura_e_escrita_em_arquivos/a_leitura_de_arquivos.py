...
para o arquivo a ser lido. Essa função retorna um _io.TextIOWrapper e é com ele que tabralhamos então.
...
# OBS: O Python, utiliza um recurso para trabalhar com arquivos chamado cursor. Esse cursor, funciona como cursor
