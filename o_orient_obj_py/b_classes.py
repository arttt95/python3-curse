...
Em POO (Programação Orientada a Objetos), Classes nada mais são do que modelos dos objetos do
...
Classes podem conter:
    ...
    *** Atributos -> Representam as características do objeto. Ou seja, pelos atributos conseguimos
    representar computacionalemnte os estados de um objeto. No caso da lâmpada, possivelmente
    iríamos querer saber se a lâmpada é 110 ou 220 volts, se ela é branca, amarela, vermelha ou de
    outra cor, qual é a luminoisidade dela e etc.
...
em maiúsculo. Se o nome for composto, utiliza-se as iniciais de ambas as palavras em maiúsculo, todas juntas.

Dica Geek: Em computação não utilizamos: Acentuação, cacteres especiais, espaços ou similares para nomes de classes,
...
estes objetos que serão moldados nessas classes de ENTIDADES.
"""
