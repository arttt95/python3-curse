...
Atributos -> Representam as características de um objeto. Ou seja, pelos atributos nós
...
Em Pyhton, por convenção, ficou estabelecido que, todo atributo de uma classe é público.
...
# Ou seja, ao invés de cada instância da classe ter seus próprios valores como é o caso dos atributos de instância,
...
# OBS: O atributos dinâmico será exclusivo da instância que o criou.
